...
{ /*{{{*/
    ...
    puts("m 1 2 3 - multiply matrix 1 by 2 and store it into 3");
    puts("r 1 - read matrix 1");
    puts("p 1 - print matrix 1");
    puts("* 1 x - multiply all items of matrix 1 by number x");
    puts("+ 1 x - add value x to all items of matrix 1");
    puts("e 1 i j x - set matrix 1 item at i-th row and j-th column to x");
    puts("i 1 i j - print value of matrix 1 item at i-th row and j-th column");
    puts("t 1 - transpose matrix 1");
} /*}}}*/

/** Reads param_count numbers and calls the corresponding matrix operation */
